    ...
    <div class="view">
      <div class="pages">
        <div class="page" data-page="page-webapp-form-edit">
		 <form id="sendForm" action="/defaultroot/workflow/firstsend.controller" method="post">
							...
							<td>
								<c:choose>
									...
									<c:when test="${showtype =='113' && readwrite =='1'}">
										<div>
											<textarea name='_main_<x:out select="$fd/sysname/text()"/>'  onkeyup="$(this).next('.edit-form-num').html($(this).attr('maxlength')-$(this).val().length );"   class="edit-txta edit-txta-l" maxlength="300"><x:out select="$fd/value/text()"/></textarea>
