    ...
    <div class="view view-main">
      <div class="pages">
						  ...
						  <ul class="edit-radio">
							<li>
							  <label class="label-checkbox item-content">
								<input type="checkbox" name="selfRecovery" id='selfRecovery'/>
								<span class="edit-radio-l">自动返回</span>
							  </label>
							</li>
						  </ul>
						</div>
        ...
        <div class="panel-btn" id="footerButton">
          	<a href="javascript:onSubmit();" class="panel-btn-a panel-close">确认转办</a>
        </div>
