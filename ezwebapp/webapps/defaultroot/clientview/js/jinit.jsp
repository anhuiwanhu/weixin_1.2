...
%>
<%
		String jsapi_ticket = com.whir.aop.weixin.utils.WeiXinUtils.getJSToken(request);
...
<script>
	wx.config({
      ...
      jsApiList: [
        'hideMenuItems','closeWindow','getNetworkType','openEnterpriseChat','scanQRCode','openLocation','getLocation','hideOptionMenu'
      ]
	});
